  ...
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
        Dokumentit ladataan ylös työ-, koulutus- ja projektilomakkeilla. Täällä voit poistaa
        yksittäisiä tiedostoja.
      </Typography>
      <Table>
        <TableHead>
          <TableRow>
        ...
        <TableBody>
          ...
          {documents.length === 0 && <AdminEmptyTableRow colSpan={6} message="Ei dokumentteja." />}
        </TableBody>
      </Table>
    </Container>
  );
