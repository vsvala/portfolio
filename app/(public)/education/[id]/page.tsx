  ...
  return (
    <Container maxWidth="md" sx={{ py: 6 }}>
      ...
      <FeedbackForm
        ...
        targetTitle={
          lang === "fi"
            ? `${education.degree_fi} — ${education.institution_fi}`
            : `${education.degree_en} — ${education.institution_en}`
        }
      />
    </Container>
  );
