    ...
    <Container maxWidth="md" sx={{ py: 6 }}>
      ...
      <Typography
        ...
        sx={{
          lineHeight: 1.9,
          whiteSpace: "pre-line",
          mb: project.category === "graffathon" ? 2 : 4,
        }}
      >
        {lang === "fi"
      ...
      {project.category === "graffathon" && (
        <Typography variant="body1" color="text.secondary" sx={{ lineHeight: 1.9, mb: 4 }}>
          Graffathon is a weekend-long demoscene / computer art hackathon. Newbies and seasoned
          sceners alike create real-time audiovisual art in small teams or individually. Every
          participant is encouraged to create a non-interactive audiovisual computer program during
          the weekend.{" "}
          <a
