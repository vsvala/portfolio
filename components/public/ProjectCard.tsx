    ...
    <Card>
      <CardActionArea component={Link} href={`/projects/${project.id}`}>
        <CardContent>
              ...
              {project.url && (
                <IconButton
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    e.stopPropagation();
                    window.open(project.url ?? undefined, "_blank", "noopener,noreferrer");
                  }}
                >
              ...
              {project.repo_url && (
                <IconButton
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    e.stopPropagation();
                    window.open(project.repo_url ?? undefined, "_blank", "noopener,noreferrer");
                  }}
                >
          ...
          {project.status && (
            <Chip label={project.status} size="small" color="warning" sx={{ mb: 1 }} />
          )}
