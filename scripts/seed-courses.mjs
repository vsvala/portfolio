...
const courses = [
  // ── Ohjelmointi ──────────────────────────────────────────────────────────
  {
    ...
    url: 'https://fullstackopen.com', sort_order: 1, education_id: HY_ID,
  },
  {
  ...
  },
  {
    ...
    url: null, sort_order: 4, education_id: HY_ID,
  },
  {
    ...
    url: null, sort_order: 5, education_id: HY_ID,
  },
  {
    ...
    url: null, sort_order: 6, education_id: HY_ID,
  },
  {
    ...
    url: null, sort_order: 7, education_id: HY_ID,
  },
  {
    ...
    url: null, sort_order: 8, education_id: HY_ID,
  },
  {
    ...
    url: null, sort_order: 9, education_id: HY_ID,
  },
  {
    ...
    url: null, sort_order: 10, education_id: HY_ID,
  },
  ...
  // ── Tietokannat ──────────────────────────────────────────────────────────
  {
    ...
    url: null, sort_order: 1, education_id: HY_ID,
  },
  {
  ...
  // ── Tekoäly & data ───────────────────────────────────────────────────────
  {
    ...
    url: 'https://www.elementsofai.com', sort_order: 1, education_id: HY_ID,
  },
  {
...
for (const c of courses) {
  await db.execute({
    sql: `INSERT INTO courses (name_fi, name_en, institution_fi, institution_en, category, credits, year,
          description_fi, description_en, url, sort_order, education_id)
          VALUES (:name_fi, :name_en, :institution_fi, :institution_en, :category, :credits, :year,
          :description_fi, :description_en, :url, :sort_order, :education_id)`,
    args: { ...c, url: c.url ?? null },
  })
}
