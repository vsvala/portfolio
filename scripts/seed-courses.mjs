...
const courses = [
  // ── Ohjelmointi ──────────────────────────────────────────────────────────
  {
    ...
    category: 'programming', credits: 18, year: 2019,
    description_fi: 'Kattava Full Stack -kurssi: React, Node.js, Express, MongoDB, GraphQL, TypeScript, CI/CD. Sisälsi kurssin (8 op) ja harjoitustyön (10 op).',
    description_en: 'Comprehensive Full Stack course: React, Node.js, Express, MongoDB, GraphQL, TypeScript, CI/CD. Included coursework (8 cr) and project (10 cr).',
    url: 'https://fullstackopen.com', grade: '5 / Hyv.', sort_order: 1, education_id: HY_ID,
  },
  {
    ...
    category: 'programming', credits: 5, year: 2018,
    description_fi: 'JavaScript-ohjelmoinnin tekniikat, funktionaalinen ohjelmointi ja modernit JS-käytännöt.',
    description_en: 'JavaScript programming techniques, functional programming and modern JS practices.',
    url: null, grade: '5', sort_order: 2, education_id: HY_ID,
  },
  {
    ...
    institution_fi: 'Helsingin yliopisto', institution_en: 'University of Helsinki',
    category: 'programming', credits: 5, year: 2018,
    description_fi: 'Web-sovellusten rakentaminen Ruby on Rails -kehyksellä. MVC-arkkitehtuuri, tietokannat, autentikointi.',
    description_en: 'Building web applications with Ruby on Rails. MVC architecture, databases, authentication.',
    url: null, grade: '5', sort_order: 3, education_id: HY_ID,
  },
  {
    name_fi: 'Web-palvelinohjelmointi Java',
    name_en: 'Web Server Programming Java',
    institution_fi: 'Helsingin yliopisto', institution_en: 'University of Helsinki',
    category: 'programming', credits: 5, year: 2019,
    ...
    url: null, grade: '5', sort_order: 4, education_id: HY_ID,
  },
  {
    name_fi: 'Ohjelmistotuotanto',
    name_en: 'Software Engineering',
    institution_fi: 'Helsingin yliopisto', institution_en: 'University of Helsinki',
    category: 'programming', credits: 6, year: 2018,
    description_fi: 'Ketterät menetelmät (Scrum, Kanban), testaus, CI/CD, versionhallinta tiimityössä.',
    description_en: 'Agile methods (Scrum, Kanban), testing, CI/CD, version control in team work.',
    url: null, grade: '5', sort_order: 5, education_id: HY_ID,
  },
  {
    name_fi: 'Ohjelmistotuotantoprojekti',
    name_en: 'Software Engineering Project',
    institution_fi: 'Helsingin yliopisto', institution_en: 'University of Helsinki',
    category: 'programming', credits: 10, year: 2019,
    description_fi: 'Ryhmäprojekti oikealle asiakkaalle ketterillä menetelmillä. Vaatimusmäärittely, suunnittelu, toteutus ja testaus.',
    description_en: 'Group project for a real client using agile methods. Requirements, design, implementation and testing.',
    url: null, grade: '5', sort_order: 6, education_id: HY_ID,
  },
  {
    ...
    url: null, grade: '5', sort_order: 7, education_id: HY_ID,
  },
  {
    name_fi: 'Ohjelmoinnin perusteet',
    name_en: 'Introduction to Programming',
    institution_fi: 'Helsingin yliopisto (Avoin yo)', institution_en: 'University of Helsinki (Open University)',
    category: 'programming', credits: 5, year: 2016,
    description_fi: 'Ohjelmoinnin peruskäsitteet Javalla.',
    description_en: 'Programming fundamentals with Java.',
    url: null, grade: '4', sort_order: 8, education_id: HY_ID,
  },
  {
  ...
  // ── Tekoäly & data ───────────────────────────────────────────────────────
  {
    ...
    institution_fi: 'Helsingin yliopisto (Avoin yo)', institution_en: 'University of Helsinki (Open University)',
    category: 'ai_data', credits: 2, year: 2019,
  ...
  // ── Järjestelmät & verkot ────────────────────────────────────────────────
  {
    ...
    institution_fi: 'Helsingin yliopisto', institution_en: 'University of Helsinki',
    category: 'systems', credits: 5, year: 2019,
    description_fi: 'Käyttöjärjestelmien rakenne, prosessit, muistinhallinta, tiedostojärjestelmät.',
  ...
  },
  {
    ...
    institution_fi: 'Helsingin yliopisto', institution_en: 'University of Helsinki',
    category: 'systems', credits: 10, year: 2018,
    ...
    url: null, grade: '1', sort_order: 3, education_id: HY_ID,
  },
  ...
  // ── Matematiikka & tilastot ──────────────────────────────────────────────
  {
    ...
    institution_fi: 'Helsingin yliopisto', institution_en: 'University of Helsinki',
    category: 'math', credits: 10, year: 2017,
  ...
  },
  {
    ...
    url: null, sort_order: 3, education_id: HY_ID,
  },
]
