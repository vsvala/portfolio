...
const workEntries = [
  {
    ...
    technologies: JSON.stringify([
      ...
      'SQL', 'Leaflet', 'MapLibre', 'Git', 'Kanban', 'Scrum',
...
if (countWork.n > 0 || countEdu.n > 0) {
  console.log(`Database already has ${countWork.n} work entries and ${countEdu.n} education entries.`)
  console.log('Skipping seed to avoid duplicates. Delete existing rows first if you want to re-seed.')
  db.close()
  process.exit(0)
}
...
console.log(`✓ Seeded ${workEntries.length} work entries and ${educationEntries.length} education entries.`)
