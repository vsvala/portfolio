...
const projects = [
  {
    title_fi: "vaDOD — Graffathon 2024",
    title_en: "vaDOD — Graffathon 2024",
    description_fi: "Ryhmätyöpajademo Graffathon 2024 -tapahtumassa.",
    description_en: "Group workshop demo at Graffathon 2024.",
    long_description_fi:
      "Graffathon 2024 -työpajaprojekti, jossa yhdistettiin vektoripohjainen graafinen suunnittelu ja koodattu visuaalisuus p5.js:llä. Työ osoittaa kyvyn yhdistää luova visuaalinen suunnittelu suoraan koodiin perustuvaan toteutukseen.",
    long_description_en:
      "A Graffathon 2024 workshop project combining vector-based graphic design with coded visuals using p5.js. Demonstrates the ability to integrate creative visual design with code-based implementation.",
  ...
  {
    title_fi: "Murrr — Assembly 2019 One Scene",
    title_en: "Murrr — Assembly 2019 One Scene",
    description_fi:
      "vaDOD-ryhmän audiovisuaalinen demo Assembly 2019 -tapahtuman One Scene -kilpailuun.",
    description_en: "vaDOD group audiovisual demo for the Assembly 2019 One Scene competition.",
    long_description_fi:
      "Assembly 2019 -tapahtuman One Scene -kilpailuun valmistettu tiiviin aikarajoitteen audiovisuaalinen demotuotos vaDOD-ryhmässä. Projekti vaati tehokasta koodin optimointia ja tiimityötä visuaalisen ilmeen ja teknisen suorituskyvyn tasapainottamiseksi.",
    long_description_en:
      "An audiovisual demo produced under tight time constraints for the Assembly 2019 One Scene competition as part of the vaDOD group. The project required efficient code optimisation and close teamwork to balance visual expression with technical performance.",
    technologies: JSON.stringify(["JavaScript", "WebGL", "Canvas"]),
    url: null,
    repo_url: "https://github.com/vsvala/murrr",
    document_id: null,
    sort_order: 2,
  },
  {
    title_fi: "Mandaloid — Graffathon 2018",
    title_en: "Mandaloid — Graffathon 2018",
    description_fi:
      "Proseduraalinen mandala-generaattori. 2. sija Newcomer-sarjassa Graffathon-demopartyssa.",
    description_en:
      "Procedural mandala generator. 2nd place in the Newcomer category at Graffathon demoparty.",
    long_description_fi:
    ...
    long_description_en:
      "A Graffathon workshop project focused on procedural graphics and algorithm visualisation. The project generates mandalas dynamically through code, demonstrating understanding of geometric algorithms and their real-time visual representation. Placed 2nd in the Newcomer/Beginner category.",
  ...
  {
    title_fi: "Graffathon 2017 — Itsenäinen osallistuminen",
    title_en: "Graffathon 2017 — Solo Entry",
    ...
    long_description_fi:
      "Itsenäinen osallistuminen Graffathon-demopartyyn vuonna 2017. Graffathon on Aalto-yliopiston järjestämä demoscene-tapahtuma, jossa ohjelmoijat, muusikot ja graafikot luovat reaaliaikaisia audiovisuaalisia teoksia kilpaillen eri kategorioissa.",
    long_description_en:
      "Solo entry at the Graffathon demoparty in 2017. Graffathon is a demoscene event organised by Aalto University where programmers, musicians and graphic artists create real-time audiovisual works competing across different categories.",
...
console.log(
  `✓ Seeded ${work.length} work, ${education.length} education, ${projects.length} project entries into Turso.`
);
