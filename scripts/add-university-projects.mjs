...
await db.execute({
  sql: `UPDATE projects SET category = 'university_solo', sort_order = 3 WHERE id = 6`,
  args: [],
});
...
const soloProjects = [
  {
    ...
    description_fi:
      "Full Stack -harjoitustyö: taidekerhon hallintasovellus. React-frontend ja Node.js/Express-backend erillisistä repoista.",
    description_en:
      "Full Stack coursework project: an art club management application. React frontend and Node.js/Express backend in separate repos.",
  ...
  },
  {
    ...
    description_fi:
      "Web-palvelinohjelmointi-kurssin harjoitustyö. Viinien arvostelusovellus Ruby on Rails -kehyksellä.",
    description_en:
      "Web server programming coursework. A wine rating application built with Ruby on Rails.",
  ...
  },
  {
    ...
    description_fi:
      "Web-palvelinohjelmointi-kurssin harjoitustyö. Sosiaalisen median harjoitussovellus Javalla.",
    description_en:
      "Web server programming coursework. A social media practice application built with Java.",
...
const groupProjects = [
  {
    ...
    description_fi:
      "Ohjelmistotuotantokurssin ryhmäminiprojekti. Lukuvinkkikirjasto toteutettiin Scrum-menetelmällä Java-backendillä.",
    description_en:
      "Software Engineering course group mini-project. A reading tips library built as a Scrum team using Java backend.",
