...
const projects = [
  {
    ...
    description_fi: 'Haarautuma DeepLearning.AI:n "Claude Code: A Highly Agentic Coding Assistant" -kurssin RAG-chatbot-koodipohjaksi.',
    description_en: 'Fork of the DeepLearning.AI "Claude Code: A Highly Agentic Coding Assistant" course RAG chatbot starter codebase.',
  ...
  },
  {
    ...
    description_fi: 'Viinisuositusten RAG-sovellus, joka käyttää OpenAI-upotuksia, FAISS-vektorihakua, hybridirankkausta ja GPT-4o-mini-selityksiä. Node.js + React.',
    description_en: 'Wine recommendation RAG app using OpenAI embeddings, FAISS vector search, hybrid ranking, and GPT-4o-mini LLM explanations. Node.js + React.',
  ...
  },
  {
    ...
    description_fi: 'Full Stack -chatbot-sovellus, joka on rakennettu Google Gemini 2.5 Flash -rajapinnan päälle. Kehitetty Claude Codella agenttilähtöisellä lähestymistavalla.',
    description_en: 'A fullstack chatbot application built on generative AI using the Google Gemini 2.5 Flash API. Built with Claude Code using an AI agent-driven development approach.',
...
for (const p of projects) {
  await db.execute({
    ...
    args: [
      ...
      p.technologies, p.repo_url, p.sort_order,
    ],
  })
